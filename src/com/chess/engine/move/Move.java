...
public abstract class Move {
    ...
    // Då vårt board är immutable så kan vi ej ändra på brädet
    // Vi skickar därför tillbaka ett nytt bräde vid drag
    ...
    // Skiljer sig från PawnAttackMove
    ...
    public static class PawnPromotion extends Move {
        ...
        @Override
        public String toString() {
            String notation = BoardUtils.getPositionAtCoordinate(this.destinationCoordinate);
            notation += (this.promotedPawn.getPieceAlliance().isWhite()) ? "Q":"q";
            return  notation;
        }
    ...
    public static class KingSideCastleMove extends CastleMove {
        ...
        @Override
        // "Convention to write out king-side castle"
        public String toString() {
            return "0-0";
        }
    }
